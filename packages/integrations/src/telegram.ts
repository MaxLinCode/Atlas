...
function parseTelegramSendMessageResponse(payload: unknown): TelegramSendMessageResponse {
...
function isTelegramSendMessageResponse(payload: unknown): payload is TelegramSendMessageResponse {
  if (!payload || typeof payload !== "object") {
    return false;
  }

...
export const slotExtractorSystemPrompt = buildPromptSpec([
  ...
  },
  {
    ...
    lines: [
      ...
      "- time: { hour: number, minute: number } — 24-hour integers. Never return a string like '5pm'. If the user says '5' in a scheduling context, interpret as 17:00 (PM bias for scheduling). If ambiguous, set confidence below 0.75.",

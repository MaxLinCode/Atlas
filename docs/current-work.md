...
The next rollout validation step is a small smoke-test PR to confirm Vercel Preview stays isolated from production data and the hosted migration workflow is ready to gate future `main` releases.
